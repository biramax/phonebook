...
def run():
    ...
    while True:
        ...
        # model возвращает список словарей: 
        # [
        #   {'family': фамилия, 'name': имя, 'phone': телефон},
        #   {'family': фамилия, 'name': имя, 'phone': телефон},
        #   {'family': фамилия, 'name': имя, 'phone': телефон},
        #   ...
        # ]
        ...
        # model производит поиск подстроки по каждой строке файла и возвращает список словарей, как в предыдущем пункте.
        ...
        # model производит поиск подстроки, как в предыдущем пункте, но возвращает не всех найденных, а только первого (нужно создать ф-ю find_first), возврат стандартно в виде списка словарей, хотя и из всего одного словаря: 
        # [
        #   {'family': фамилия, 'name': имя, 'phone': телефон}
        # ]
